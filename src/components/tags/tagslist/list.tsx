...
export default function TagsList() {
  ...
  const [editingTags, setEditingTags] = useState<ITags | null>(null);
  ...
  const handleStatusChange = (status: string) => {
    ...
    fetchTags(); // This will be called due to useEffect dependency
  };
  // Fetch Organizations
  ...
  // Modal Controls
  const openModal = (org?: ITags) => {
    setEditingTags(org || null);
    setIsModalOpen(true);
  };
  ...
  useEffect(() => {
    fetchTags();
  }, [debouncedSearchTerm, selectedStatus, page, fetchTags]);
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-blue-100">Manage your tag listings</p>
          </div>
          <motion.button
          ...
          >
            <div className="flex justify-between items-center px-6 py-4 border-b">
              <h2 className="text-xl font-semibold">
                {editingTags ? 'Edit Tags' : 'New Tags'}
              </h2>
              <button
                onClick={closeModal}
            ...
            <div className="p-6">
              <TagsForm
                initialData={editingTags ? { 
                  ...editingTags, 
                  description: editingTags.description || '' 
                } : undefined}
                onCancel={closeModal}
