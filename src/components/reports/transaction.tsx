        ...
        <>
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 mb-6">
            ...
            <ul className="text-gray-600 list-disc list-inside">
              <li><strong>Purpose:</strong> This page allows you to analyze your transactions by type, including total amounts and counts.</li>
              ...
              <li><strong>View Table Data:</strong> Review the table to see the total amount and count of transactions per type.</li>
              <li><strong>Interpret Charts:</strong> Use the bar chart to compare transaction amounts and the pie chart to see the distribution of transaction types.</li>
